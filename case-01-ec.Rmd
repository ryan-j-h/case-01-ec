...
tab4 <- function(condition = "T") {
  ...
  absdif <- round(c((test$estimate[1] - test$estimate[2]) * 100, test$conf.int * 100), 1) %>% as.data.frame()
  ...
  return(list(props2, absdif, rr))
}


# Ejection fraction
# 0.25-0.45
tab4("ejf_per >= 25 & ejf_per <= 45")
# <0.25
tab4("ejf_per < 25")
...
# NYHA class
# I or II
tab4("functcls %in% c(1,2)")
# III or IV
tab4("functcls %in% c(3,4)")
